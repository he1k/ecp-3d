...
MODEL                := mod_win
MODULES              := mod_win_data.c mod_win_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := mod_win.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := mod_win_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/farfar/Documents/Git/ecp-3d/software/matlab;C:/Users/farfar/Documents/Git/ecp-3d/software/matlab/mod_win_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
